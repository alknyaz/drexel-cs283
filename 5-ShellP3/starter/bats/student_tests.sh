...
EOF
    ...
    # Expected output with all whitespace removed for easier matching
    expected_output="dsh3> error: piping limited to 8 commandsdsh3> cmd loop returned -2"
...
EOF
    ...
    # Expected output with all whitespace removed for easier matching
    expected_output="test1test2dsh3>dsh3>cmdloopreturned0"
...
@test "Eliminate duplicate spaces between strings" {
    run "./dsh" <<EOF                
echo     hello     world
EOF
...
@test "Eliminate duplicate spaces around quoted strings" {
    run "./dsh" <<EOF                
echo     "hello  "     "  world"    
EOF
...
@test "Unclosed quoted string returns ERR_CMD_ARGS_BAD" {
    run "./dsh" <<EOF                
echo "hello world
EOF
    ...
    # Expected output with all whitespace removed for easier matching
    expected_output="dsh3> dsh3> cmd loop returned -4"
...
EOF
    ...
    # Expected output with all whitespace removed for easier matching
    expected_output="dsh3> dsh3> cmd loop returned 1"
